...
pub const BINDINGS: &[Binding] = &[
    ...
    Binding { keys: "l",        desc: "Expand node (fetch children)", ctx: Context::Tree, action: Action::TreeExpand },
    Binding { keys: "h",        desc: "Collapse node",        ctx: Context::Tree,      action: Action::TreeCollapse },
    Binding { keys: "c",        desc: "Collapse/expand subtree recursively", ctx: Context::Tree, action: Action::TreeToggleRecursive },
    Binding { keys: "J / K",    desc: "Next / prev sibling (same level)", ctx: Context::Tree, action: Action::TreeNextSibling },
    Binding { keys: "L / H",    desc: "Level in (first child) / out (parent)", ctx: Context::Tree, action: Action::TreeLevelIn },
    Binding { keys: "Enter",    desc: "Open in detail",       ctx: Context::Tree,      action: Action::Open },
    Binding { keys: "/",        desc: "Fuzzy filter (Esc clears)", ctx: Context::Tree,  action: Action::Open },
    Binding { keys: "r",        desc: "Refresh tree (re-fetch)", ctx: Context::Tree,   action: Action::RefreshTree },
    Binding { keys: "o",        desc: "Open item in ADO web UI", ctx: Context::Tree,   action: Action::OpenInBrowser },
    Binding { keys: "y",        desc: "Yank menu (yy summary · yl link · yn number · yv verbose)", ctx: Context::Tree, action: Action::OpenYankMenu },
    Binding { keys: "R",        desc: "Export HTML report of the tree (opens in browser)", ctx: Context::Tree, action: Action::ExportTreeReport },
    Binding { keys: "i",        desc: "Filter by iteration (sprint)", ctx: Context::Tree, action: Action::OpenIterationFilter },
    // Work items list
    ...
    Binding { keys: "v",        desc: "View item in tree (parents & children)", ctx: Context::WorkItems, action: Action::ViewInTree },
    Binding { keys: "/",        desc: "Fuzzy filter the list (Esc clears)", ctx: Context::WorkItems, action: Action::Open },
    Binding { keys: "f",        desc: "Filter by timeframe (date window)", ctx: Context::WorkItems, action: Action::OpenTimeframeFilter },
    Binding { keys: "i",        desc: "Filter by iteration (sprint)", ctx: Context::WorkItems, action: Action::OpenIterationFilter },
    Binding { keys: "F",        desc: "Clear time filter (iteration & date range)", ctx: Context::WorkItems, action: Action::ClearTimeFilter },
    Binding { keys: "t",        desc: "Filter by item type", ctx: Context::WorkItems, action: Action::OpenTypeFilter },
    Binding { keys: "r",        desc: "Reload list",          ctx: Context::WorkItems, action: Action::Reload },
    Binding { keys: "o",        desc: "Open item in ADO web UI", ctx: Context::WorkItems, action: Action::OpenInBrowser },
    Binding { keys: "y",        desc: "Yank menu (yy summary · yl link · yn number · yv verbose)", ctx: Context::WorkItems, action: Action::OpenYankMenu },
    // Detail
    ...
    Binding { keys: "d",        desc: "Delete selected comment (deferred)", ctx: Context::Detail, action: Action::DeleteComment },
    Binding { keys: "p",        desc: "Push pending edits",   ctx: Context::Detail,    action: Action::Push },
    Binding { keys: "o",        desc: "Open item in ADO web UI", ctx: Context::Detail, action: Action::OpenInBrowser },
    Binding { keys: "X",        desc: "Simulate teammate edit (demo)", ctx: Context::Detail, action: Action::SimulateRemote },
    // Resolution-options menu (shown only on genuine divergence)
    Binding { keys: "j / k",    desc: "Select conflicting field", ctx: Context::Conflict, action: Action::Down },
    Binding { keys: "m",        desc: "Merge selected in $EDITOR", ctx: Context::Conflict,  action: Action::ResolveMerge },
    Binding { keys: "f",        desc: "Force-push my changes",ctx: Context::Conflict,  action: Action::ResolveForce },
    Binding { keys: "Esc",      desc: "Cancel (keep pending)",ctx: Context::Conflict,  action: Action::Back },
    // Config
